...
/// matching web's `{isHome && <WidgetManager/>}`. Used by Teacher Portal's
/// own top bar (`TeacherTopBar`) — Admin manages widgets via its own
/// full-page `WidgetsPage` bottom-nav tab instead.
class WidgetManagerButton extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    // avatar) into overflow — same collapse strategy as `SearchTrigger`,
