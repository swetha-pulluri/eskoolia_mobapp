        ...
        children: [
          ...
          if (invoices.results.isEmpty)
            ...
            ...invoices.results.map((invoice) {
              ...
              final daysOverdue =
                  (dueDate != null && invoice.status == 'overdue')
                                ...
                                children: [
                                  ...
                                  Column(
                                    ...
                                    children: [
                                      Text(
                                        _formatINR(
                                          invoice.taxBreakdown.grandTotal,
                                        ),
                                      ...
                                      if (invoice.dueAmount > 0 &&
                                          invoice.status != 'cancelled')
                                        Text(
                                          'Due ${_formatINR(invoice.dueAmount, compact: false, symbol: false)}',
                                          style: AppTextStyles.sectionSubtitle
                                              .copyWith(
                                                fontFamily: 'monospace',
                                                fontSize: 9.5,
                              ...
                              Wrap(
                                ...
                                children: [
                                  _metaChip(
                                    ...
                                    '${buyerCode.isNotEmpty ? '$buyerCode — ' : ''}${invoice.buyerState.isEmpty ? '—' : invoice.buyerState} · ${inter ? 'Inter-state' : 'Intra-state'}',
                                  ),
                                  _metaChip(
                      ...
                      child: Row(
                        ...
                        children: [
                          ...
                          _rowActionIcon(
                            icon: Icons.block,
                            tooltip: invoice.status == 'paid'
                                ? 'Paid invoice — issue credit note instead'
                                : invoice.status == 'cancelled'
                                ? 'Already cancelled'
                                : 'Cancel invoice',
