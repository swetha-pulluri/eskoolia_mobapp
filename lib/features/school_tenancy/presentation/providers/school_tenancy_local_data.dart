...
class SchoolTenancyLocalData {
    ...
    return BillingStateEntity(
      invoices: [
        ...
        InvoiceEntity(
          ...
          amount: 56400,
          status: 'overdue',
          issuedDate: DateTime(2026, 6, 10),
          dueDate: DateTime(2026, 7, 10),
          buyerState: 'Tamil Nadu',
        ),
      ],
      // Plan names & prices are taken verbatim from the web "Add school" plan
      // dropdown (schools/page.tsx SectionHead 07 "Plan & capacity limits").
      plans: const [
        SubscriptionPlanEntity(
          code: 'trial',
          name: 'Starter',
          priceInr: 4500,
          description: 'Trial-friendly plan for schools onboarding to Eskoolia.',
        ),
        SubscriptionPlanEntity(
          code: 'standard',
          name: 'Standard',
          priceInr: 9000,
          description: 'Core ERP modules for a single-campus school.',
        ),
        SubscriptionPlanEntity(
          code: 'premium',
          name: 'Premium',
          priceInr: 19500,
          description: 'Advanced modules, SSO & priority support.',
        ),
        SubscriptionPlanEntity(
          code: 'enterprise',
          name: 'Enterprise',
          priceInr: 34500,
          description: 'Multi-campus groups with dedicated data residency.',
        ),
      ],
    );
  }
    ...
    return AuditStateEntity(
      events: [
        ...
        AuditEventEntity(
          ...
          severity: 'warning',
          affectedFields: const ['gst.default_rate'],
          beforeValues: const {'gst.default_rate': 9},
          afterValues: const {'gst.default_rate': 18},
        ),
        AuditEventEntity(
          id: 'ev-005',
          ...
          status: 'failed',
          errorMessage: 'Auto-payment failed \u2014 card declined by issuing bank.',
        ),
        AuditEventEntity(
          id: 'ev-006',
          ...
          detail: 'API key rotated for The Heritage School',
          severity: 'warning',
          tenantId: 'ten-her',
        ...
        AuditEventEntity(
          ...
          actorIp: '103.27.8.14',
          action: 'plan.upgrade',
          detail: 'Plan upgraded Starter \u2192 Premium for Kendriya Vidyalaya',
          severity: 'info',
          tenantId: 'ten-kv',
        ...
        AuditEventEntity(
          id: 'ev-008',
          timestamp: now.subtract(const Duration(hours: 11)).toIso8601String(),
          actor: 'superadmin@eskoolia.com',
          actorIp: '103.27.8.14',
          action: 'backup.complete',
          detail: 'Nightly backup completed \u2014 47 schemas, 2.4 GB',
          severity: 'info',
        ),
        AuditEventEntity(
          id: 'ev-009',
          timestamp: now.subtract(const Duration(hours: 14)).toIso8601String(),
          actor: 'system',
          actorIp: '127.0.0.1',
          action: 'migration.complete',
          detail: 'Schema migration v11\u2192v12 completed for all 47 tenants',
          severity: 'info',
        ),
        AuditEventEntity(
          id: 'ev-010',
          timestamp: now.subtract(const Duration(hours: 20)).toIso8601String(),
          actor: 'ops@eskoolia.com',
          actorIp: '49.36.51.109',
          action: 'school.archive',
          detail: 'School archived: Little Angels (license expired)',
          severity: 'critical',
          tenantId: 'ten-la',
        ...
        AuditEventEntity(
          ...
          actorIp: '103.27.8.14',
          action: 'auth.login',
          detail: 'Super admin login from 103.27.8.14',
          severity: 'info',
        ),
        AuditEventEntity(
          id: 'ev-012',
          ...
          actorIp: '103.27.8.14',
          action: 'invoice.sent',
          detail: 'Invoice INV-2026-0044 sent to Delhi Public School',
          severity: 'info',
          tenantId: 'ten-dps',
          schoolName: 'Delhi Public School',
        ),
  ...
  /// Read-only platform settings shown on the Policies page's right-hand
  /// panel on web (DEMO_SETTINGS in super-admin/policies/page.tsx).
  static Map<String, Map<String, dynamic>> getPlatformSettings() {
    return {
      'system': {
