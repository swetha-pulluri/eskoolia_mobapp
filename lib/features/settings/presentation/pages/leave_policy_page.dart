    ...
    return const Padding(
      ...
      child: Row(
        children: [
          ...
          SizedBox(width: 10),
          Text('Loading leave policies…', style: TextStyle(fontSize: 14, color: AppColors.textSecondary)),
        ],
      ),
    );
  }
      ...
      child: Column(
        children: [
          Container(
            ...
            child: const Icon(Icons.date_range_outlined, size: 21, color: AppColors.purpleAccent),
          ),
          const SizedBox(height: 14),
          const Text('Set up your first leave type', style: TextStyle(fontSize: 16, fontWeight: FontWeight.w700, color: AppColors.textPrimary)),
        ...
        ElevatedButton(
          ...
          child: const Row(
            ...
            children: [
              Icon(Icons.add, size: 14),
              SizedBox(width: 6),
              Text('Add Another Leave Type', style: TextStyle(fontSize: 12.5, fontWeight: FontWeight.w700)),
            ],
          ),
        ),
      ],
